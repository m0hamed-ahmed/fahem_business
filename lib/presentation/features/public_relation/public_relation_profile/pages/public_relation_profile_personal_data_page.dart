...
class PublicRelationProfilePersonalDataPage extends StatefulWidget {
  
  const PublicRelationProfilePersonalDataPage({Key? key}) : super(key: key);

  @override
  State<PublicRelationProfilePersonalDataPage> createState() => _PublicRelationProfilePersonalDataPageState();
}

class _PublicRelationProfilePersonalDataPageState extends State<PublicRelationProfilePersonalDataPage> {
  ...
  void initState() {
    ...
    _textEditingControllerName.text = publicRelationProfileProvider.name ?? '';
    _textEditingControllerEmailAddress.text = publicRelationProfileProvider.emailAddress ?? '';
    _textEditingControllerPassword.text = publicRelationProfileProvider.password ?? '';
    _textEditingControllerAddress.text = publicRelationProfileProvider.address ?? '';
    _textEditingControllerPhoneNumber.text = publicRelationProfileProvider.phoneNumber ?? '';
  }
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Personal Image *
              Selector<PublicRelationProfileProvider, XFile?>(
                  ...
                  return Center(
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if(xFile != null) publicRelationProfileProvider.changeImage(xFile);
                      },
                      child: Container(
                        ...
                        child: image == null
                            ? CachedNetworkImageWidget(image: ApiConstants.fileUrl(fileName: '${ApiConstants.publicRelationsDirectory}/${publicRelationProfileProvider.imageNameFromDatabase}'))
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => publicRelationProfileProvider.setName(val),
                validator: (val) {
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => publicRelationProfileProvider.setEmailAddress(val),
                validator: (val) {
              ...
              // Password *
              Selector<PublicRelationProfileProvider, bool>(
                ...
                builder: (context, isShowPassword, child) {
                  return CustomTextFormField(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () => publicRelationProfileProvider.changeIsShowPassword(),
                      icon: Icon(isShowPassword ? Icons.visibility_off : Icons.visibility, color: ColorsManager.primaryColor),
                    ),
                    onChanged: (val) => publicRelationProfileProvider.setPassword(val),
                    validator: (val) {
                      if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                      return null;
                    },
              ...
              // Governorate *
              Selector<PublicRelationProfileProvider, GovernmentModel?>(
                ...
                builder: (context, governmentModel, _) {
                  return DropDownWidget(
                    ...
                    onChanged: (val) => publicRelationProfileProvider.changeGovernmentModel(val as GovernmentModel),
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => publicRelationProfileProvider.setAddress(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                  return null;
                },
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => publicRelationProfileProvider.setPhoneNumber(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish);}
