...
class LawyerReviewsProvider with ChangeNotifier {
  final GetLawyerReviewsForOneUseCase _getLawyerReviewsForOneUseCase;

  LawyerReviewsProvider(this._getLawyerReviewsForOneUseCase);

  Future<Either<Failure, List<LawyerReviewModel>>> getLawyerReviewsForOneImpl(GetLawyerReviewsForOneParameters parameters) async {
    return await _getLawyerReviewsForOneUseCase.call(parameters);
  }
