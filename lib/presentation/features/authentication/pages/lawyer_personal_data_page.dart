...
class LawyerPersonalDataPage extends StatefulWidget {
  
  const LawyerPersonalDataPage({Key? key}) : super(key: key);

  @override
  State<LawyerPersonalDataPage> createState() => _LawyerPersonalDataPageState();
}

class _LawyerPersonalDataPageState extends State<LawyerPersonalDataPage> {
  ...
  void initState() {
    ...
    _textEditingControllerName.text = registerLawyerProvider.name ?? '';
    _textEditingControllerEmailAddress.text = registerLawyerProvider.emailAddress ?? '';
    _textEditingControllerPassword.text = registerLawyerProvider.password ?? '';
    _textEditingControllerAddress.text = registerLawyerProvider.address ?? '';
    _textEditingControllerPhoneNumber.text = registerLawyerProvider.phoneNumber ?? '';
  }
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Personal Image *
              Selector<RegisterLawyerProvider, XFile?>(
                ...
                builder: (context, image, child) {
                  return image == null ? CustomButton(
                    ...
                    onPressed: () async {
                      ...
                      if(xFile != null) registerLawyerProvider.changeImage(xFile);
                    },
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () => registerLawyerProvider.changeImage(null),
                          ),
                        ),
                      ],
                    ),
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setName(val),
                validator: (val) {
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setEmailAddress(val),
                validator: (val) {
              ...
              // Password *
              Selector<RegisterLawyerProvider, bool>(
                ...
                builder: (context, isShowPassword, child) {
                  return CustomTextFormField(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () => registerLawyerProvider.changeIsShowPassword(),
                      icon: Icon(isShowPassword ? Icons.visibility_off : Icons.visibility, color: ColorsManager.primaryColor),
                    ),
                    onChanged: (val) => registerLawyerProvider.setPassword(val),
                    validator: (val) {
                      if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                      return null;
                    },
              ...
              // Governorate *
              Selector<RegisterLawyerProvider, GovernmentModel?>(
                ...
                builder: (context, governmentModel, _) {
                  return DropDownWidget(
                    ...
                    onChanged: (val) => registerLawyerProvider.changeGovernmentModel(val as GovernmentModel),
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setAddress(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                  return null;
                },
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setPhoneNumber(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish);}
