...
class LegalAccountantPersonalDataPage extends StatefulWidget {
  
  const LegalAccountantPersonalDataPage({Key? key}) : super(key: key);

  @override
  State<LegalAccountantPersonalDataPage> createState() => _LegalAccountantPersonalDataPageState();
}

class _LegalAccountantPersonalDataPageState extends State<LegalAccountantPersonalDataPage> {
  ...
  void initState() {
    ...
    _textEditingControllerName.text = registerLegalAccountantProvider.name ?? '';
    _textEditingControllerEmailAddress.text = registerLegalAccountantProvider.emailAddress ?? '';
    _textEditingControllerPassword.text = registerLegalAccountantProvider.password ?? '';
    _textEditingControllerAddress.text = registerLegalAccountantProvider.address ?? '';
    _textEditingControllerPhoneNumber.text = registerLegalAccountantProvider.phoneNumber ?? '';
  }
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Personal Image *
              Selector<RegisterLegalAccountantProvider, XFile?>(
                ...
                builder: (context, image, child) {
                  return image == null ? CustomButton(
                    ...
                    onPressed: () async {
                      ...
                      if(xFile != null) registerLegalAccountantProvider.changeImage(xFile);
                    },
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () => registerLegalAccountantProvider.changeImage(null),
                          ),
                        ),
                      ],
                    ),
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLegalAccountantProvider.setName(val),
                validator: (val) {
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLegalAccountantProvider.setEmailAddress(val),
                validator: (val) {
              ...
              // Password *
              Selector<RegisterLegalAccountantProvider, bool>(
                ...
                builder: (context, isShowPassword, child) {
                  return CustomTextFormField(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () => registerLegalAccountantProvider.changeIsShowPassword(),
                      icon: Icon(isShowPassword ? Icons.visibility_off : Icons.visibility, color: ColorsManager.primaryColor),
                    ),
                    onChanged: (val) => registerLegalAccountantProvider.setPassword(val),
                    validator: (val) {
                      if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                      return null;
                    },
              ...
              // Governorate *
              Selector<RegisterLegalAccountantProvider, GovernmentModel?>(
                ...
                builder: (context, governmentModel, _) {
                  return DropDownWidget(
                    ...
                    onChanged: (val) => registerLegalAccountantProvider.changeGovernmentModel(val as GovernmentModel),
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLegalAccountantProvider.setAddress(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                  return null;
                },
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLegalAccountantProvider.setPhoneNumber(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish);}
