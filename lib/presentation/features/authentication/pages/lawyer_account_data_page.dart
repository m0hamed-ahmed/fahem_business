...
class LawyerAccountDataPage extends StatefulWidget {

  const LawyerAccountDataPage({Key? key}) : super(key: key);

  @override
  State<LawyerAccountDataPage> createState() => _LawyerAccountDataPageState();
}

class _LawyerAccountDataPageState extends State<LawyerAccountDataPage> {
  ...
  void initState() {
    ...
    _textEditingControllerJobTitle.text = registerLawyerProvider.jobTitle ?? '';
    _textEditingControllerInformation.text = registerLawyerProvider.information ?? '';
    _textEditingControllerConsultationPrice.text = registerLawyerProvider.consultationPrice ?? '';
  }
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setJobTitle(val),
                validator: (val) {
              ...
              Stack(
                ...
                children: [
                  Selector<RegisterLawyerProvider, int>(
                          ...
                          children: List.generate(lawyersCategoriesProvider.lawyersCategories.length, (index) {
                            return InkWell(
                              onTap: () {
                                ...
                                registerLawyerProvider.toggleCategoryId(lawyersCategoriesProvider.lawyersCategories[index].lawyerCategoryId.toString());
                              },
                              child: Container(
                                padding: const EdgeInsets.all(SizeManager.s5),
                                decoration: BoxDecoration(
                                  color: registerLawyerProvider.categoriesIds.contains(lawyersCategoriesProvider.lawyersCategories[index].lawyerCategoryId.toString())
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setInformation(val),
                validator: (val) {
                  if(Validator.isEmpty(val!)) {return Methods.getText(StringsManager.required, appProvider.isEnglish).toCapitalized();}
                  return null;
                },
              ...
              CustomTextFormField(
                ...
                onChanged: (val) => registerLawyerProvider.setConsultationPrice(val),
                validator: (val) {
                        ...
                        suffixIcon: Row(
                          ...
                          children: [
                            CustomButton(
                              ...
                              onPressed: () {
                                registerLawyerProvider.addInTasks(_textEditingControllerTask.text.trim());
                      ...
                      Selector<RegisterLawyerProvider, int>(
                        ...
                        builder: (context, tasksLength, _) {
                          return Wrap(
                            spacing: SizeManager.s5,
                            runSpacing: SizeManager.s5,
                            children: List.generate(registerLawyerProvider.tasks.length, (index) {
                              return InkWell(
                                onTap: () {
                                  FocusScope.of(context).unfocus();
                                  registerLawyerProvider.removeFromTasks(registerLawyerProvider.tasks[index]);
                                },
                                child: Container(
                                  padding: const EdgeInsets.all(SizeManager.s5),
                                  decoration: BoxDecoration(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        registerLawyerProvider.tasks[index],
                      ...
                      children: [
                        CustomButton(
                          ...
                          onPressed: () async {
                            ...
                            if(xFile != null) {
                              registerLawyerProvider.addInImages(xFile);
                            }
                          },
                                ...
                                return Stack(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(SizeManager.s10),
                                        child: Image.file(File(registerLawyerProvider.images[index].path), width: SizeManager.s100, height: SizeManager.s100, fit: BoxFit.fill),
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () => registerLawyerProvider.removeFromImages(index),
                                      ),
                                    ),
                                  ],
                                );
              ...
              // Latitude & Longitude *
              Selector<RegisterLawyerProvider, Position?>(
                      ...
                      return AbsorbPointerWidget(
                        ...
                        child: CustomButton(
                          ...
                          onPressed: position != null ? () {} : () async {
                            FocusScope.of(context).unfocus();
                            registerLawyerProvider.changeIsDetectLocationClicked(true);
                            await Methods.checkPermissionAndGetCurrentPosition(context).then((position) {
                              registerLawyerProvider.changeIsDetectLocationClicked(false);
                              registerLawyerProvider.changePosition(position);
                            });
                          },
                          text: position == null
