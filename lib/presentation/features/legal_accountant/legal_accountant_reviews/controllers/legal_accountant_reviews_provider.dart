...
class LegalAccountantReviewsProvider with ChangeNotifier {
  final GetLegalAccountantReviewsForOneUseCase _getLegalAccountantReviewsForOneUseCase;

  LegalAccountantReviewsProvider(this._getLegalAccountantReviewsForOneUseCase);

  Future<Either<Failure, List<LegalAccountantReviewModel>>> getLegalAccountantReviewsForOneImpl(GetLegalAccountantReviewsForOneParameters parameters) async {
    return await _getLegalAccountantReviewsForOneUseCase.call(parameters);
  }
